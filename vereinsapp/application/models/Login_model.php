...
class Login_model extends CI_Model {
  ...
  public function dauerhaft_angemeldet( $identifier, $securitytoken ) {
    $dauerhaft_angemeldet = $this->mitglieder_model->mitglieder_dauerhaft_angemeldet( NULL, array( 'identifier' => $identifier ) );
    if( !empty($dauerhaft_angemeldet) ) {
      $dauerhaft_angemeldet = $dauerhaft_angemeldet[ array_key_last($dauerhaft_angemeldet) ];
      if( array_key_exists( 'securitytoken', $dauerhaft_angemeldet ) AND password_verify( $securitytoken, $dauerhaft_angemeldet['securitytoken'] ) )
