      ...
      <tbody>
        <tr>
          <td valign="top" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
            <table class="container p-0" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
              <tbody>
                <tr>
                  <td align="center" style="line-height: 24px; font-size: 16px; margin: 0; padding: 0;">
                    <!--[if (gte mso 9)|(IE)]>
                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            <td class="col-md-12" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                              <div class="row no gutters" style="margin-right: -24px;">
                                                <table class="" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; width: 100%;" width="100%">
                                                  <tbody>
                                                    <tr>
                                                      <td class="col  text-center" style="line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; margin: 0;" align="center" valign="top">
                                                        <a href="<?php echo site_url(); ?>" style="color: #0d6efd;"><img class="title" src="<?php echo base_url('images/title.png'); ?>" width="50" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; border: 0 none;"></a>
                                                      </td>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td class="col" style="line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; margin: 0;" align="left" valign="top">
                                                        Hallo <?php echo htmlentities( $mitglied['vorname'], ENT_QUOTES, 'utf-8' ); ?>,
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              ...
                                              <div class="row no gutters" style="margin-right: -24px;">
                                                <table class="" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; width: 100%;" width="100%">
                                                  <tbody>
                                                    <tr>
                                                      <td class="col" style="line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; margin: 0;" align="left" valign="top">
                                                        <?php echo htmlentities( $email['text'], ENT_QUOTES, 'utf-8' ); ?>
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              ...
                                              <div class="row no gutters" style="margin-right: -24px;">
                                                <table class="" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; width: 100%;" width="100%">
                                                  <tbody>
                                                    <tr>
                                                      <td class="col m-3" style="line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; margin: 0;" align="left" valign="top">
                                                        <table class="btn btn-outline-primary btn-block" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important;">
                                                          <tbody>
                                                            <tr>
                                                              <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0; border: #0d6efd;" align="center" bgcolor="transparent">
                                                                <a href="<?php echo $button['link']; ?>" style="color: #0d6efd; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: transparent; padding: 8px 12px; border: 1px solid #0d6efd;"><?php echo htmlentities( $button['beschriftung'], ENT_QUOTES, 'utf-8' ); ?></a>
                                                              </td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                              ...
                                              <div class="row no gutters" style="margin-right: -24px;">
                                                <table class="" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; width: 100%;" width="100%">
                                                  <tbody>
                                                    <tr>
                                                      <td class="col text-secondary small" style="line-height: 24px; font-size: 10px; min-height: 1px; font-weight: normal; padding-right: 24px; color: #718096; margin: 0;" align="left" valign="top">
                                                        <?php echo htmlentities( $email['hinweis'], ENT_QUOTES, 'utf-8' ); ?>
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
