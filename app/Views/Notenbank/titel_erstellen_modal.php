  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="form-floating mb-2">
        <input type="text" class="form-control eigenschaft" data-eigenschaft="titel" placeholder="<?= EIGENSCHAFTEN['notenbank']['notenbank']['titel']['beschriftung']; ?>" />
        <label><?= EIGENSCHAFTEN['notenbank']['notenbank']['titel']['beschriftung']; ?></label>
      </div>

      <div class="col-4 form-floating mb-2">
        <input type="number" class="form-control eigenschaft" data-eigenschaft="titel_nr" placeholder="<?= EIGENSCHAFTEN['notenbank']['notenbank']['titel_nr']['beschriftung']; ?>" />
        <label><?= EIGENSCHAFTEN['notenbank']['notenbank']['titel_nr']['beschriftung']; ?></label>
      </div>

      <?php if( array_key_exists( 'kategorie', EIGENSCHAFTEN['notenbank']['notenbank'] ) ) { ?><div class="form-floating mb-2">
        ...
        <label><?= EIGENSCHAFTEN['notenbank']['notenbank']['kategorie']['beschriftung']; ?></label>
      </div><?php } ?>
