...
<div class="invisible" role="group">
    ...
    <button type="button" class="btn btn_aufgabe_offen_erledigt_markieren bestaetigung_einfordern btn-sm" data-title="Aufgabe als offen/erledigt markieren"><i class="bi bi-<?= SYMBOLE['aktiv']['bootstrap'] ?>"></i></button>
</div>
