<div class="formular">
  ...
  <div class="input-group mb-1">
    ...
    <button type="button" class="btn btn_abwesenheit_erstellen btn-outline-success" data-liste="abwesenheiten" data-aktion="erstellen" data-werte='<?= json_encode( array( 'mitglied_id' => $mitglied_id ), JSON_UNESCAPED_UNICODE ); ?>'><i class="bi bi-<?= SYMBOLE['erstellen']['bootstrap']; ?>"></i></button>
  </div>
