...
<div class="input-group mb-1">
  ...
  <button type="button" class="btn btn_mitglied_passwort_aendern btn-outline-success" data-liste="mitglieder" data-aktion="passwort_aendern" data-element_id="<?= ICH['id']; ?>"><i class="bi bi-<?= SYMBOLE['mitglied']['bootstrap']; ?>"></i> Mein Passwort ändern</button>
