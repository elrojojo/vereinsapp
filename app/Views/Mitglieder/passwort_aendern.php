...
<div class="input-group mb-1">
  ...
  <button type="button" class="btn_erfolgreich_abschliessen btn btn-outline-success" data-liste="mitglieder" data-aktion="passwort_aendern" data-element_id="<?= ICH['id']; ?>"><i class="bi bi-<?= SYMBOLE['mitglied']['bootstrap']; ?>"></i> Mein Passwort ändern</button>
