<div class="modal fade formular" id="mitglied_erstellen_Modal" tabindex="-1" aria-labelledby="mitglied_erstellen_Modal_Label" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <?php if( array_key_exists( 'adresse', EIGENSCHAFTEN['mitglieder'] ) ) { ?><div class="form-floating mb-2">
        <input type="text" class="form-control eigenschaft" data-eigenschaft="adresse" placeholder="<?= EIGENSCHAFTEN['mitglieder']['adresse']['beschriftung']; ?>" />
        <label><?= EIGENSCHAFTEN['mitglieder']['adresse']['beschriftung']; ?></label>
      </div><?php } ?>

      <?php if( array_key_exists( 'postleitzahl', EIGENSCHAFTEN['mitglieder'] ) OR array_key_exists( 'wohnort', EIGENSCHAFTEN['mitglieder'] ) ) { ?><div class="row g-2">
        <?php if( array_key_exists( 'postleitzahl', EIGENSCHAFTEN['mitglieder'] ) ) { ?><div class="col-4 form-floating mb-2">
        ...
        <?php if( array_key_exists( 'wohnort', EIGENSCHAFTEN['mitglieder'] ) ) { ?><div class="col-8 form-floating mb-2">
      ...
      <?php if( array_key_exists( 'vorstandschaft', EIGENSCHAFTEN['mitglieder'] ) OR array_key_exists( 'aktiv', EIGENSCHAFTEN['mitglieder'] ) ) { ?><div class="row g-2">
