...
<?php if( auth()->user()->can('termine.anwesenheiten') ) echo view( 'Termine/termin_anwesenheiten_modal', array( 'liste' => $liste['alle_aktiven_anwesenheiten'], 'checkliste' => $checkliste['dokumentierte_anwesenheiten'] ) ); ?>
