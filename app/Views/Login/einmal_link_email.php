                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <div class="">Hallo<?php if( isset( $mitglied_name ) ) echo ' '.$mitglied_name; ?>,</div>
                                            ...
                                            <table class="btn btn-outline-primary" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important;">
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="transparent">
                                                    <a href="<?= url_to('verify-magic-link') ?>?token=<?= $token ?>" style="color: #0d6efd; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: transparent; padding: 8px 12px; border: 1px solid #0d6efd;">Einmal-Link verwenden</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                            ...
                                            <div class="small text-secondary" style="color: #718096;"><i><?= esc($ipAddress) ?> / <?= esc($userAgent) ?> / <?= esc($date) ?></i></div>
                                            <table class="s-1 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 4px; font-size: 4px; width: 100%; height: 4px; margin: 0;" align="left" width="100%" height="4">
