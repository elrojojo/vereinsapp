...
class Strafkatalog extends BaseController {
    ...
    //     if( empty( model(Strafe_Model::class)->find( $element_id ) ) ) throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
    ...
    //             'title' => 'Strafe löschen',
    //             'farbe' => 'danger',
    //             'weiterleiten' => 'strafkatalog',
    //         );
    //     }

    //     $this->viewdata['element_navigation'] = array(
    //         'instanz' => 'aktueller_strafkatalog',
    //         'sortieren' => array(
    //             array( 'eigenschaft' => 'kategorie', 'richtung' => SORT_ASC, ),
    //             array( 'eigenschaft' => 'titel', 'richtung' => SORT_ASC, ),
    //             array( 'eigenschaft' => 'wert', 'richtung' => SORT_ASC, ),
    ...
    //     echo view( 'Strafkatalog/strafe_details', $this->viewdata );
    // }
