function Aufgaben_AufgabeMitgliedAusplanen(bestaetigung_einfordern, dom, title, aufgabe_id) {
    ...
    let mitglied;
    if (Schnittstelle_VariableRausZurueck("mitglied_id", aufgabe_id, "aufgaben") == ICH["id"]) mitglied = "dich";
    else mitglied = Liste_ElementBeschriftungZurueck(Schnittstelle_VariableRausZurueck("mitglied_id", aufgabe_id, "aufgaben"), "mitglieder");
