function Schnittstelle_VariableLoeschen(element_id, liste) {
    if (typeof element_id !== "undefined" && typeof liste !== "undefined") {
        ...
        // Elemente in anderen Listen suchen und löschen, die auf das zu löschende Element verlinken (mittels [x]_id
        // noch nicht implementiert: oder mittels liste und element_id)
