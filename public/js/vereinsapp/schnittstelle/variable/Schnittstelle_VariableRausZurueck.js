function Schnittstelle_VariableRausZurueck(eigenschaft, element_id, liste, quelle) {
    ...
    if (
        ...
        typeof G.LISTEN[liste].tabelle[element_id] !== "undefined" &&
        // "id" in G.LISTEN[liste].tabelle[element_id] &&
        eigenschaft in G.LISTEN[liste].tabelle[element_id]
    )
        VariableRaus = G.LISTEN[liste].tabelle[element_id][eigenschaft];
