function Schnittstelle_EventElementErgaenzenTermine(termin) {
    ...
    if ("filtern_mitglieder" in termin) {
        ...
        G.LISTEN.mitglieder.instanz["filtern_mitglieder_" + termin["id"]] = { filtern: termin["filtern_mitglieder"], sortieren: new Array() };
    ...
    if (termin["kategorie"] in TERMINE_KATEGORIE_FILTERN_MITGLIEDER) {
        termin_kategorie_filtern_mitglieder = TERMINE_KATEGORIE_FILTERN_MITGLIEDER[termin["kategorie"]];
        termin_kategorie_filtern_mitglieder = Liste_SqlFiltern2FilternZurueck(termin_kategorie_filtern_mitglieder, "mitglieder");
