function Liste_FilternPositionGeloeschtZurueck(filtern, position, position_uebrig) {
    if (typeof position === "undefined" || !isArray(position)) position = new Array();
    if (typeof position_uebrig === "undefined" || !isArray(position_uebrig)) {
    ...
    if ("verknuepfung" in filtern[position_ebene]) {
        ...
        if (typeof position_uebrig !== "undefined" && isArray(position_uebrig) && position_uebrig.length === 0) filtern.splice(position_ebene, 1);
    }
