function Liste_SortierenSpeichern($sortieren, instanz, liste) {
    const $btn_sortieren_oeffnen = Schnittstelle_DomLetztesWartendesModalZurueck().find(".btn_sortieren_oeffnen[data-liste='" + liste + "']");
    ...
    } else if ($btn_sortieren_oeffnen.exists()) $btn_sortieren_oeffnen.val(JSON.stringify(Liste_$Sortieren2SortierenZurueck($sortieren, liste)));
}
