function Liste_VerzeichnisInit() {
    $.each(LISTEN, function (liste) {
        ...
        $('.verzeichnis[data-liste="' + liste + '"]').each(function () {
            ...
            LISTEN[liste].verzeichnis[instanz].$blanko_unterverzeichnis = $verzeichnis.find(".blanko").first();
            $verzeichnis.empty();
            LISTEN[liste].verzeichnis[instanz].$blanko_datei = LISTEN[liste].verzeichnis[instanz].$blanko_unterverzeichnis.find(".blanko").first();
