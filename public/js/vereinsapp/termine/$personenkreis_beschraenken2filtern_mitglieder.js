function $personenkreis_beschraenken2filtern_mitglieder(
    ...
    $personenkreis_beschraenken
        ...
        .each(function () {
            ...
            if ($knoten.hasClass("personenkreis_beschraenken_sammlung")) {
                const verknuepfung = $knoten
                    .find(".verknuepfung")
                    .attr("data-verknuepfung");
                filtern.push({
                    verknuepfung: verknuepfung,
                    filtern: $personenkreis_beschraenken2filtern_mitglieder(
                        $knoten
                ...
                const operator = $knoten
                    .find(".operator")
                    .attr("data-operator");
                const eigenschaft = $knoten
                    .find(".eigenschaft")
                    .attr("data-eigenschaft");
                ...
                if (
                    ...
                    wert = Number(wert);
                if (
                    typeof EIGENSCHAFTEN[LISTE.controller][liste][
                        eigenschaft
                    ] !== "undefined" &&
