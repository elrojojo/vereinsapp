function $personenkreis_beschraenken2filtern_mitglieder( $personenkreis_beschraenken, liste ) {
    
    const LISTE = LISTEN[ liste ];
    const filtern = new Array();

    $personenkreis_beschraenken.children('.personenkreis_beschraenken_element, .personenkreis_beschraenken_sammlung').each( function() {
