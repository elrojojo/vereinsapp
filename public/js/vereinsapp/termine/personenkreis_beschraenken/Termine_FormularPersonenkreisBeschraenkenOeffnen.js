function Termine_FormularPersonenkreisBeschraenkenOeffnen(
    $formular,
    event,
    liste
) {
    ...
    $formular
        .find(
            ".personenkreis_beschraenken, .personenkreis_beschraenken_definitionen"
        )
    ...
    $.each(
        FILTERBARE_EIGENSCHAFTEN[filtern_liste],
        function (index, eigenschaft) {
            const EIGENSCHAFT =
            ...
            $neue_personenkreis_beschraenken_definition
                ...
                .attr(
                    "data-bs-target",
                    "#personenkreis_beschraenken_" + eigenschaft
                )
                .text(beschriftung);
            $neue_personenkreis_beschraenken_definition
            ...
            if (typ == "vorgegebene_werte") {
                $neue_personenkreis_beschraenken_definition
                    ...
                    .empty();
                $.each(
                    VORGEGEBENE_WERTE[filtern_liste][eigenschaft],
                    function (wert, eigenschaften) {
                        $(
                            '<option value="' +
                                wert +
                                '">' +
