function Termine_PersonenkreisBeschraenkenErstellen( $btn, liste ) {
    ...
    $formular.find('.personenkreis_beschraenken_wert').each( function() {
        ...
        if( $personenkreis_beschraenken_wert.val() ) {
            ...
            if( typeof EIGENSCHAFTEN[ LISTEN[ filtern_liste ].controller ][ filtern_liste ][ eigenschaft ] !== 'undefined' && EIGENSCHAFTEN[ LISTEN[ filtern_liste ].controller ][ filtern_liste ][ eigenschaft ]['typ'] == 'zeitpunkt' ) wert = DateTime.fromISO( wert );
