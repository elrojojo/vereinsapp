function Mitglieder_PermissionAendern( $check, liste ) {
    ...
    $.ajaxQueue( {
        ...
        url: BASE_URL+'/'+liste+'/ajax_'+gegen_element+'_'+check_element+'_'+aktion+'', method: 'post',
        ...
        success: function(antwort) {
            ...
            if( typeof antwort.validation !== 'undefined' ) console.log( 'FEHLER '+element+' '+aktion+': validation -> '+JSON.stringify(antwort.validation) );
                ...
                if( !( 'permissions' in LISTEN[ liste ].tabelle[gegen_element_id] ) || typeof LISTEN[ liste ].tabelle[gegen_element_id].permissions !== 'object' ) LISTEN[ liste ].tabelle[gegen_element_id].permissions = new Array();
